...
const formSchema = z.object({
  salesDate: z
    .date()
    .min(new Date("1900-01-01"), "Sales Date must be after Jan 1, 1900"),
...
export default function SalesContent() {
  const { vehicle, salesDetails, salesPayments, sRemaining, totalCost } =
    useVehicleContext();
  ...
  return (
    <div className="p-4">
      ...
      {vehicle?.vehicleStatus === "sold" && <Separator className="my-4" />}
