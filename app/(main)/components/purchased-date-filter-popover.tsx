...
export function PurchasedDateFilterPopover({
  tab,
  onDateChange,
}: PurchasedDateFilterPopoverProps) {
    ...
    <Popover>
      ...
      <PopoverContent className="w-80 p-4 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <CalendarPopover value={toDate} onChange={setToDate} label="To" />
        </div>

        <Button className="mt-2" onClick={() => onDateChange(fromDate, toDate)}>
          Apply
        </Button>
      </PopoverContent>
    </Popover>
